...
<html>
	...
	<body>
			...
			<div style="width: 100%; text-align: center;">
				<form autocomplete="off" role="form" method="post" action="/SIMS/user/join_stu" id="stu_register_form">
					<table style="display: inline-block;">
						<tbody>
							...
							<tr>
								<td class="underline">
									<input placeholder="학번" type="student_id" id="student_id" name="student_id" required/>
								</td>
							</tr>
							<tr>
								<td class="underline">
