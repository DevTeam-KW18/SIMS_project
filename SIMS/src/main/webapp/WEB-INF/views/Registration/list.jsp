...
<html>
	...
	<body>
		...
		<div id="root">
			...
			<section id="container">
				...
				<table>
					...
					<tr><th>과목명</th><th>학정번호</th><th>교수명</th><th>학점</th><th>과목구분</th></tr>
		...
		<input placeholder="검색어를 입력하세요" style="width:200px; margin-left:20px; margin-right:20px;" type="text" name="keyword" id="keywordInput" value="${cri.keyword}"/>
